...
if($giaca!=0) echo "<a href='?action=tinhchat".$arr[0]."'><div class='btn btn-info'><img src='image/exit.png' height='20' width='20'> ".$gia1['thap']."000VND-".$gia1['cao']."000VND"."</div></a>";
if($sao!=0) echo "<a href='?action=tinhchat".$arr[1]."'><div class='btn btn-info'><img src='image/exit.png' height='20' width='20'>".$sao1['thap']."-".$sao1['cao']."</div></a>";
if($mausac!=0) echo "<a href='?action=tinhchat".$arr[2]."'><div class='btn btn-info'><img src='image/exit.png' height='20' width='20'>".$mau1['ten']."</div></a>";
if($kichco!=0) echo "<a href='?action=tinhchat".$arr[3]."'><div class='btn btn-info'><img src='image/exit.png' height='20' width='20'>".$kichco1['ten']."</div></a>";
 ?>
<form>
<select id="sl">
